...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        # Edit wants to try out new to-do list app, so browses to its homepage.
        self.browser.get(self.live_server_url)

        # She should see the page title mentions to-do lists.
        ...
        # Now a new user, Fransis comes to the site.

        ## Create a new browser session to make sure no information
